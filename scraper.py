...
class BettingOddsScraper:
    def __init__(self):
        ...
        self.leagues = {
            ...
            'MLS': 'usa/mls/fixtures/',
            'Club World Cup': 'world/fifa-club-world-cup/fixtures/',
            'Serie A Betano': 'brazil/serie-a-betano/fixtures/',
            'Torneo Betano': 'argentina/torneo-betano/fixtures/'
        }
        self.headers = {
